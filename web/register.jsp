...
<div class="container"
    ...
    <div class="row">
        ...
        <div class="col-md-8"
            ...
            <form id="registerForm" class="form-horizontal" action="${pageContext.request.contextPath}/RegisterServlet"
                ...
                <div class="form-group opt">
                    ...
                    <div class="col-sm-6">
                        ...
                        <label class="error" for="sex" style="display: none">还没选择性别呢</label>
                    </div>
                </div>
                <div class="form-group">
