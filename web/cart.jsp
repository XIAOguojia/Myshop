...
<%--判断购物车是否为空，如果为空，则显示图片，如果不为空则展示购物车中的商品--%>
<c:if test="${empty cart.cartItems}">
    <div>
        <img src="${pageContext.request.contextPath }/images/cart-empty.png">

        <span style="color:black;font-size:50px" >购物车为空</span>
        <span style="color:red;font-size:50px"><a href="${pageContext.request.contextPath }">返回首页</a></span>
    </div>
</c:if>
<c:if test="${!empty cart.cartItems}">
    <div class="container">
